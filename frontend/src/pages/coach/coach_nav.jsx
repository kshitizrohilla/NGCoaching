  ...
  return (
    <div className='px-20 flex justify-between fixed top-0 left-0 right-0 h-20 bg-orange-900'>
        ...
        <div className='text-lg font-bold flex space-x-4 bg-transparent justify-center items-center'>
            ...
            <div onClick={() => navigate('/admin/showsession')} className='bg-transparent cursor-pointer'>Assigned Sessions</div>
            <div onClick={() => navigate('/admin/registercoach')} className='bg-transparent cursor-pointer'>Register Student</div>
